			...
			console.log(JSON.stringify(data));
                    ...
                    function resizeCanvas() {
                         ...
                         var margin = {top: 20, right: 20, bottom: 30, left: 70},
                            width = $("#Teams_container").innerWidth()/2 - margin.left - margin.right, //$("#container").innerWidth()/2 - margin.left - margin.right,
                        ...
                        y1.domain([0,2000]);//(d3.extent(throughput_arr_1, function(d) { return (d.value/1000); }));
                        ...
                        y2.domain([0,2000]);//(d3.extent(throughput_arr_2, function(d) { return (d.value/1000); }));
                        ...
                        y3.domain([0,2000]);//d3.extent(throughput_arr_3, function(d) { return (d.value/1000); }));
                        ...
                        y4.domain([0,2000]);//(d3.extent(throughput_arr_0, function(d) { return (d.value/1000); }));
                        ...
                        yB.domain([0,4000]);//d3.extent(throughput_arr_3, function(d) { return (d.value/1000); }));
              ...
              svgA.append("path")
                ...
                svgA.append("g")
                  ...
                  console.log(" Team A score is:"+A_score+" Team B score is:"+B_score);
